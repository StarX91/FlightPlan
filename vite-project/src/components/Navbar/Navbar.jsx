    ...
    <div className={`card ${theme === 'Dark' ? 'flex justify-between bg-black w-full h-1/6 min-[320px]:w-full' : 'flex justify-between bg-zinc-200 w-full h-1/6 min-[320px]:w-full'}`}>
      ...
      <div className="flex py-3 gap-4">
        ...
        <div className="flex gap-1">
          ...
          <button className={`card ${theme === 'Dark' ? 'px-4 py-2 bg-white rounded-md my-2  mr-2 text-black font-semibold': 'px-4 py-2 bg-black rounded-md my-2  mr-2 text-zinc-50 font-semibold'}`}>Save</button>
        </div>
    </div>
  );
};
